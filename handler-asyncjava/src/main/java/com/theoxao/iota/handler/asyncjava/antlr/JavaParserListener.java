package com.theoxao.iota.handler.asyncjava.antlr;
...
public interface JavaParserListener extends ParseTreeListener {
    ...
    /**
     * Enter a parse tree produced by {@link JavaParser#awaitExpression}.
     *
     * @param ctx the parse tree
     */
    void enterAwaitExpression(JavaParser.AwaitExpressionContext ctx);

    /**
     * Exit a parse tree produced by {@link JavaParser#awaitExpression}.
     *
     * @param ctx the parse tree
     */
    void exitAwaitExpression(JavaParser.AwaitExpressionContext ctx);
